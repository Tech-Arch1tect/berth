...
func SeedRBACData(db *gorm.DB) error {
	permissions := []user.Permission{
		...
		{Name: permnames.FilesRead, Resource: "files", Action: "read", Description: "Read files within stacks. Browsing and downloading backup contents (including volume data) requires this permission plus backups.read", IsAPIKeyOnly: false},
		...
		{Name: permnames.BackupsRead, Resource: "backups", Action: "read", Description: "View stack backups. Browsing and downloading backup contents (including volume data) requires this permission plus files.read", IsAPIKeyOnly: false},
