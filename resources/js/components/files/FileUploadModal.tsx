  ...
  const modalContent = (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="relative w-full h-full flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className={cn(theme.modal.content, 'max-w-3xl w-full max-h-[85vh] overflow-hidden')}>
          {/* Header */}
          <div className={theme.modal.header}>
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className={cn('text-xl font-semibold', theme.text.strong)}>Upload Files</h2>
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className={cn('text-sm mt-2', theme.text.subtle)}>
