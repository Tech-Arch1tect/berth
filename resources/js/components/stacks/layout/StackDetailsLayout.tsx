...
const SIDEBAR_STORAGE_KEY = 'berth-stack-details-sidebar-width';
const SIDEBAR_COLLAPSED_STORAGE_KEY = 'berth-stack-details-sidebar-collapsed';

interface StackDetailsLayoutProps {
...
export const StackDetailsLayout: React.FC<StackDetailsLayoutProps> = ({
  toolbar,
  sidebar,
  content,
  statusBar,
