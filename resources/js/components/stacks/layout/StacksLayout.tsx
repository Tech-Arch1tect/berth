...
const SIDEBAR_STORAGE_KEY = 'berth-stacks-sidebar-width';
const SIDEBAR_COLLAPSED_STORAGE_KEY = 'berth-stacks-sidebar-collapsed';
...
export const StacksLayout: FC<StacksLayoutProps> = ({ toolbar, sidebar, content, statusBar }) => {
