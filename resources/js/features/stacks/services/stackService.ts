  ...
  static async getServerStacks(serverid: number): Promise<Stack[]> {
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to fetch stacks'));
      }
  ...
  static async getStackNetworks(serverid: number, stackname: string): Promise<Network[]> {
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to fetch networks'));
      }
      throw new Error('Network error occurred');
    }
  }
  ...
  static async getStackVolumes(serverid: number, stackname: string): Promise<Volume[]> {
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to fetch volumes'));
      }
      throw new Error('Network error occurred');
    }
  }
  ...
  static async getStackEnvironmentVariables(
    ...
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to fetch environment variables'));
      }
      throw new Error('Network error occurred');
    }
  }
  ...
  static async getStackPermissions(
    ...
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to fetch permissions'));
      }
      throw new Error('Network error occurred');
    }
  }
  ...
  static async getStackImages(
    ...
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to fetch image details'));
      }
      throw new Error('Network error occurred');
    }
  }
  ...
  static async getComposeConfig(serverid: number, stackname: string): Promise<RawComposeConfig> {
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to fetch compose configuration'));
      }
      throw new Error('Network error occurred');
    }
  }
  ...
  static async updateCompose(
    ...
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to update compose configuration'));
      }
      throw new Error('Network error occurred');
    }
  }
  ...
  static async createStack(serverid: number, name: string): Promise<Stack> {
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to create stack'));
      }
      throw new Error('Network error occurred');
    }
  }
  ...
  static async canCreateStack(serverid: number): Promise<boolean> {
    try {
      ...
      if (isApiError(error)) {
        ...
        throw new Error(messageFromApiError(error, 'Failed to check permissions'));
      }
      throw new Error('Network error occurred');
    }
  }
