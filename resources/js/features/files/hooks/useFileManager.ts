...
import { FileOperation, CreateArchiveRequest, ExtractArchiveRequest } from '../types';
      ...
      try {
        switch (currentOperation) {
          ...
          case 'copy':
            ...
            break;
          case 'delete':
            await mutations.deleteFile.mutateAsync(data as DeleteRequest2);
    ...
    async (
      ...
      try {
        ...
        if (options?.owner_id || options?.group_id) {
          const chownRequest: ChownRequest = {
            path,
            recursive: false,
          };
