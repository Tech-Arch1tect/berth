...
export const getGetApiV1ServersServeridStacksStacknameComposeQueryKey = (
  ...
  return [`/api/v1/servers/${serverid}/stacks/${stackname}/compose`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetApiV1ServersServeridStacksStacknameComposeQueryKey(serverid, stackname);
...
>(
  ...
  const queryOptions = getGetApiV1ServersServeridStacksStacknameComposeQueryOptions(
    serverid,
    stackname,
    options
  );
...
export type PatchApiV1ServersServeridStacksStacknameComposeMutationResult = NonNullable<
  Awaited<ReturnType<typeof patchApiV1ServersServeridStacksStacknameCompose>>
>;
...
> => {
  return useMutation(
    getPatchApiV1ServersServeridStacksStacknameComposeMutationOptions(options),
    queryClient
  );
};
/**
