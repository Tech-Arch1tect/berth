...
export const getApiV1ServersServeridStacks = async (
  serverid: number,
  options?: RequestInit
): Promise<ResponseListStacksData> => {
...
export const getGetApiV1ServersServeridStacksQueryKey = (serverid: number) => {
  return [`/api/v1/servers/${serverid}/stacks`] as const;
};
...
export const postApiV1ServersServeridStacks = async (
  ...
  options?: RequestInit
): Promise<ResponseCreateStackData> => {
...
export const getApiV1ServersServeridStacksCanCreate = async (
  serverid: number,
  options?: RequestInit
): Promise<ResponseCanCreateStackData> => {
  return apiClient<ResponseCanCreateStackData>(
    getGetApiV1ServersServeridStacksCanCreateUrl(serverid),
    {
      ...options,
      method: 'GET',
    }
...
export const getGetApiV1ServersServeridStacksCanCreateQueryKey = (serverid: number) => {
  return [`/api/v1/servers/${serverid}/stacks/can-create`] as const;
};
...
export const getApiV1ServersServeridStacksStackname = async (
  ...
  stackname: string,
  options?: RequestInit
): Promise<ResponseStackDetails> => {
  return apiClient<ResponseStackDetails>(
...
export const getGetApiV1ServersServeridStacksStacknameQueryKey = (
  ...
  return [`/api/v1/servers/${serverid}/stacks/${stackname}`] as const;
};
...
>(
  ...
  const queryKey =
    ...
    getGetApiV1ServersServeridStacksStacknameQueryKey(serverid, stackname);
...
>(
  ...
  const queryOptions = getGetApiV1ServersServeridStacksStacknameQueryOptions(
    serverid,
    stackname,
    options
  );
...
export const getApiV1ServersServeridStacksStacknameEnvironment = async (
  ...
  params?: GetApiV1ServersServeridStacksStacknameEnvironmentParams,
  options?: RequestInit
): Promise<ResponseStackEnvironmentData> => {
  return apiClient<ResponseStackEnvironmentData>(
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetApiV1ServersServeridStacksStacknameEnvironmentQueryKey(serverid, stackname, params);
...
>(
  serverid: number,
  stackname: string,
  params: undefined | GetApiV1ServersServeridStacksStacknameEnvironmentParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getApiV1ServersServeridStacksStacknameEnvironment>>,
...
>(
  ...
  const queryOptions = getGetApiV1ServersServeridStacksStacknameEnvironmentQueryOptions(
    serverid,
    stackname,
    params,
    options
...
export const getApiV1ServersServeridStacksStacknameImages = async (
  ...
  stackname: string,
  options?: RequestInit
): Promise<ResponseStackImagesData> => {
  return apiClient<ResponseStackImagesData>(
...
export const getGetApiV1ServersServeridStacksStacknameImagesQueryKey = (
  ...
  return [`/api/v1/servers/${serverid}/stacks/${stackname}/images`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetApiV1ServersServeridStacksStacknameImagesQueryKey(serverid, stackname);
...
>(
  ...
  const queryOptions = getGetApiV1ServersServeridStacksStacknameImagesQueryOptions(
    serverid,
    stackname,
    options
  );
...
export const getApiV1ServersServeridStacksStacknameNetworks = async (
  ...
  stackname: string,
  options?: RequestInit
): Promise<ResponseStackNetworksData> => {
  return apiClient<ResponseStackNetworksData>(
...
export const getGetApiV1ServersServeridStacksStacknameNetworksQueryKey = (
  ...
  return [`/api/v1/servers/${serverid}/stacks/${stackname}/networks`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetApiV1ServersServeridStacksStacknameNetworksQueryKey(serverid, stackname);
...
>(
  ...
  const queryOptions = getGetApiV1ServersServeridStacksStacknameNetworksQueryOptions(
    serverid,
    stackname,
    options
  );
...
export const getApiV1ServersServeridStacksStacknamePermissions = async (
  ...
  stackname: string,
  options?: RequestInit
): Promise<ResponseStackPermissionsData> => {
  return apiClient<ResponseStackPermissionsData>(
...
export const getGetApiV1ServersServeridStacksStacknamePermissionsQueryKey = (
  ...
  return [`/api/v1/servers/${serverid}/stacks/${stackname}/permissions`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetApiV1ServersServeridStacksStacknamePermissionsQueryKey(serverid, stackname);
...
>(
  ...
  const queryOptions = getGetApiV1ServersServeridStacksStacknamePermissionsQueryOptions(
    serverid,
    stackname,
    options
  );
...
export const getApiV1ServersServeridStacksStacknameStats = async (
  ...
  stackname: string,
  options?: RequestInit
): Promise<ResponseStackStats> => {
  return apiClient<ResponseStackStats>(
...
export const getGetApiV1ServersServeridStacksStacknameStatsQueryKey = (
  ...
  return [`/api/v1/servers/${serverid}/stacks/${stackname}/stats`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetApiV1ServersServeridStacksStacknameStatsQueryKey(serverid, stackname);
...
>(
  ...
  const queryOptions = getGetApiV1ServersServeridStacksStacknameStatsQueryOptions(
    serverid,
    stackname,
    options
  );
...
export const getApiV1ServersServeridStacksStacknameVolumes = async (
  ...
  stackname: string,
  options?: RequestInit
): Promise<ResponseStackVolumesData> => {
  return apiClient<ResponseStackVolumesData>(
...
export const getGetApiV1ServersServeridStacksStacknameVolumesQueryKey = (
  ...
  return [`/api/v1/servers/${serverid}/stacks/${stackname}/volumes`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetApiV1ServersServeridStacksStacknameVolumesQueryKey(serverid, stackname);
...
>(
  ...
  const queryOptions = getGetApiV1ServersServeridStacksStacknameVolumesQueryOptions(
    serverid,
    stackname,
    options
  );
