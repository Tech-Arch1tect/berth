 ...
 */
export const getGetWsApiServersServeridStacksStacknameEventsUrl = (
  serverid: number,
  stackname: string
) => {
...
export const getWsApiServersServeridStacksStacknameEvents = async (
  serverid: number,
  stackname: string,
  options?: RequestInit
): Promise<void> => {
...
export const getGetWsApiServersServeridStacksStacknameEventsQueryKey = (
  serverid: number,
  stackname: string
) => {
  return [`/ws/api/servers/${serverid}/stacks/${stackname}/events`] as const;
};

export const getGetWsApiServersServeridStacksStacknameEventsQueryOptions = <
  TData = Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameEvents>>,
  TError = ContainerStatusEvent | StackStatusEvent | ResponseEmpty | void,
>(
  serverid: number,
  stackname: string,
  options?: {
  ...
  const queryKey =
    ...
    getGetWsApiServersServeridStacksStacknameEventsQueryKey(serverid, stackname);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameEvents>>
  > = ({ signal }) =>
    getWsApiServersServeridStacksStacknameEvents(serverid, stackname, {
      signal,
      ...requestOptions,
    });
...
export type GetWsApiServersServeridStacksStacknameEventsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameEvents>>
>;
export type GetWsApiServersServeridStacksStacknameEventsQueryError =
  | ContainerStatusEvent
  | StackStatusEvent
  | ResponseEmpty
  | void;

export function useGetWsApiServersServeridStacksStacknameEvents<
  TData = Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameEvents>>,
  TError = ContainerStatusEvent | StackStatusEvent | ResponseEmpty | void,
>(
  serverid: number,
 ...
 */
export const getGetWsApiServersServeridStacksStacknameTerminalUrl = (
  serverid: number,
  stackname: string
) => {
...
export const getWsApiServersServeridStacksStacknameTerminal = async (
  serverid: number,
  stackname: string,
  options?: RequestInit
): Promise<void> => {
  return apiClient<void>(
    getGetWsApiServersServeridStacksStacknameTerminalUrl(serverid, stackname),
    {
      ...options,
      method: 'GET',
    }
...
export const getGetWsApiServersServeridStacksStacknameTerminalQueryKey = (
  serverid: number,
  stackname: string
) => {
  return [`/ws/api/servers/${serverid}/stacks/${stackname}/terminal`] as const;
};

export const getGetWsApiServersServeridStacksStacknameTerminalQueryOptions = <
  TData = Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameTerminal>>,
  TError =
    | TerminalStartMessage
    | TerminalInputMessage
    | TerminalResizeMessage
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetWsApiServersServeridStacksStacknameTerminalQueryKey(serverid, stackname);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameTerminal>>
  > = ({ signal }) =>
    getWsApiServersServeridStacksStacknameTerminal(serverid, stackname, {
      signal,
      ...requestOptions,
    });
...
export type GetWsApiServersServeridStacksStacknameTerminalQueryResult = NonNullable<
  Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameTerminal>>
>;
export type GetWsApiServersServeridStacksStacknameTerminalQueryError =
  | TerminalStartMessage
  | TerminalInputMessage
  | TerminalResizeMessage
  | TerminalCloseMessage
...
export function useGetWsApiServersServeridStacksStacknameTerminal<
  TData = Awaited<ReturnType<typeof getWsApiServersServeridStacksStacknameTerminal>>,
  TError =
    | TerminalStartMessage
    | TerminalInputMessage
...
>(
  ...
  const queryOptions = getGetWsApiServersServeridStacksStacknameTerminalQueryOptions(
    serverid,
    stackname,
    options
  );
