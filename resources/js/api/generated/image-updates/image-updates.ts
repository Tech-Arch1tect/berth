...
import type { ResponseEmpty, ResponseImageUpdatesData } from '../models';
...
export const getApiV1ImageUpdates = async (
  options?: RequestInit
): Promise<ResponseImageUpdatesData> => {
...
export const getGetApiV1ImageUpdatesQueryKey = () => {
  return [`/api/v1/image-updates`] as const;
};
...
export const getGetApiV1ServersServeridImageUpdatesQueryKey = (serverid: number) => {
  return [`/api/v1/servers/${serverid}/image-updates`] as const;
};
